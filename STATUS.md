...
- **18/8 ค่ำ (ด่วน — แก้การ์ดสแปมทุก 15 นาที): กรอง force ใน `importDrawerReports` (trigger ยัด event object มาทำให้ force ติดทุกรอบ) + ใช้วัน End Drawer เป็นวันยอด (หัวอีเมล "ประจำวันที่" = วันเปิดลิ้นชัก ทำยอด 18/8 โดนตีตราเป็น 17/8) + ยอดเดิมไม่เปลี่ยน = ไม่ส่งการ์ดซ้ำ**
