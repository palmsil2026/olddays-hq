...
| ไฟล์ | คืออะไร |
|---|---|
| `index.html` | LIFF app (หน้าจอที่พนักงาน/ผู้บริหาร/เจ้าของใช้) — รองรับทั้งมือถือใน LINE และเปิดบนคอม (จอกว้าง ≥900px จะเป็นเมนูด้านซ้าย) |
...
- ผู้บริหาร/เจ้าของจ่ายผ่านแท็บ **"💰 ค่าคอม"** (โผล่เฉพาะ manager/owner):
...
ปุ่ม "ดึงตอนนี้เลย" ในแอป (ปุ่ม ⚙️ มุมขวาบน) ใช้ดึงทันทีโดยไม่ต้องรอรอบ
...
2. สร้างหรือใช้ **LINE Login channel** → แท็บ LIFF → **Add**
   ...
   - Endpoint URL: URL ของ `index.html` ที่ deploy (เช่น GitHub Pages:
     `https://<user>.github.io/olddays-hq/`)
3. คัดลอก **LIFF ID**
...
4. ทดสอบ: ใช้ "ส่งสรุปยอดเข้ากลุ่มอีกครั้ง" ในเมนู ⚙️ ของแอป
